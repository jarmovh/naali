...
Requires: boost-date-time, boost-filesystem, boost-thread, boost-regex , boost-program-options, poco-foundation, poco-net, poco-util, openal-soft, openjpeg-libs, boost-test, gnutls, qtscriptgenerator, qtscriptbindings, xmlrpc-epi, libogg
%description
