...
%install
mkdir -p $HOME/rpmbuild/BUILDROOT/Tundra-Fedora-0.0-fc14.x86_64/opt/realXtend/lib
mkdir -p $HOME/rpmbuild/BUILDROOT/Tundra-Fedora-0.0-fc14.x86_64/usr/
cp -r $HOME/naali-build/naali/bin/* $HOME/rpmbuild/BUILDROOT/Tundra-Fedora-0.0-fc14.x86_64/opt/realXtend/
rm -fr $HOME/rpmbuild/BUILDROOT/Tundra-Fedora-0.0-fc14.x86_64/opt/realXtend/scenes
...
chmod 755 -R $HOME/rpmbuild/BUILDROOT/Tundra-Fedora-0.0-fc14.x86_64/*
